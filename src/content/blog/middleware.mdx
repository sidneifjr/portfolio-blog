---
title: Implementando Resend SDK via Server Actions no Next.js 15
description: teste
date: 04-06-2024
...
<H2 className='mt-6'>Highly Customizable</H2>
...
<H2 className='mt-6'>Ubiquity and Portability</H2>
...
<H2 className='mt-6'>Vibrant Community</H2>
